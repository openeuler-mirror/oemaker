...
%changelog
* Sat Mar 17 2021 miao_kaibo<miao_kaibo@outlook.com> - 1.1.2-7
- ID:NA
- SUG:NA
- DESC: delete or replace rpms which are not exist

* Sat Mar 16 2021 miao_kaibo<miao_kaibo@outlook.com> - 1.1.2-6
- ID:NA
- SUG:NA
- DESC: add exclude rpm

* Sat Mar 11 2021 miao_kaibo<miao_kaibo@outlook.com> - 1.1.2-5
- ID:NA
- SUG:NA
