...
%changelog
* Thu Dec 15 2022 wangkai <wangkai385@h-partners.com> - 2.0.0-9
- ID:NA
- SUG:NA
- DESC: Remove package openEuler-performance

* Thu Oct 27 2022 caodongxia <caodongxia@h-partners.com> - 2.0.0-8
- ID:NA
- SUG:NA
- DESC: add texlive-collection-humanities texlive-collection-langother to rpmlist exclude

* Tue Mar 15 2022 xiangyuning <xiangyuning@huawei.com> - 2.0.0-7
- ID:NA
- SUG:NA
...
* Tue Oct 12 2021 lingsheng <miaokaibo@outlook.com> - 2.0.0-5
- ID:NA
- SUG:NA
- DESC: bugfix I3OGUT

* Wed Aug 25 2021 lingsheng <lingsheng@huawei.com> - 2.0.0-4
- ID:NA
- SUG:NA
- DESC: add texlive-babel-vietnamese texlive-lexikon to rpmlist exclude

* Wed May 12 2021 miao_kaibo <miaokaibo@outlook.com> - 2.0.0-3
- ID:NA
- SUG:NA
- DESC: bugfix I3QY98

* Mon Apr 26 2021 lingsheng <lingsheng@huawei.com> - 2.0.0-2
- ID:NA
- SUG:NA
- DESC: add openal-soft-devel to rpmlist exclude
...
* Wed Apr 7 2021 miao_kaibo <miaokaibo@outlook.com> - 1.1.2-6
- ID:NA
- SUG:NA
